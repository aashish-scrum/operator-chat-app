...
<body class="antialiased">
    ...
    <div class="fabs">
        <div class="chat">
            <div class="chat_header">
                <div class="chat_option">
                    <div><span id="chat_head">Jane Doe</span></div>
                    <div><span class="agent">Agent</span><span class="online">(Online)</span></div>
            ...
            <div class="d-none" id="chatBox">
                <div id="chat_converse" class="chat_conversion chat_converse">
                    ...
                    <span class="chat_msg_item chat_msg_item_admin">Hey! Would you like to talk sales, support, or anyone?</span>
        ...
        <a id="prime" class="fab"><i class="prime zmdi zmdi-comment-outline text-white"></i></a>
    </div>
